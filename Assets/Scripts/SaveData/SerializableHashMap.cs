...
public class SerializableHashMap<TKey, TValue> : IDictionary<TKey, TValue>
{
    ...
    public SerializableHashMap(int capacity)
        : this(capacity, null)
    {
    }
 
    public SerializableHashMap(IEqualityComparer<TKey> comparer)
        : this(0, comparer)
    {
    }
 
    public SerializableHashMap(int capacity, IEqualityComparer<TKey> comparer)
    {
        if (capacity < 0)
    ...
    public SerializableHashMap(IDictionary<TKey, TValue> dictionary)
        : this(dictionary, null)
    {
    }
 
    public SerializableHashMap(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer)
   ...
   public ICollection<TValue> Values
   {
    ...
    {
        private readonly SerializableHashMap<TKey, TValue> _Dictionary;
        ...
        internal Enumerator(SerializableHashMap<TKey, TValue> dictionary)
        {
